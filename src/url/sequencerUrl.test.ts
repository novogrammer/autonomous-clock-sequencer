...
describe("parseSequencerUrl", () => {
  ...
  it("kit=drum-standard を復元する", () => {
    expect(
      parseSequencerUrl(
        "?kit=drum-standard&pattern=10_01_1",
      ),
    ).toEqual({
      bpm: 120,
      stepsPerBeat: 4,
      ...
      kit: "drum-standard",
      pattern:
        "1000000000000000_0100000000000000_1000000000000000_0000000000000000_0000000000000000_0000000000000000_0000000000000000_0000000000000000",
      swing: 0,
    });
  });
...
describe("normalizePattern", () => {
  ...
  it("8 track drum kit でも不足trackを0で補完する", () => {
    expect(
      normalizePattern("1_01_1111", {
        kit: "drum-standard",
        stepsPerBeat: 2,
        beatsPerLoop: 2,
      }),
    ).toBe("1000_0100_1111_0000_0000_0000_0000_0000");
  });
});
...
describe("buildSequencerUrl", () => {
  ...
  it("drum-standard の共有状態を URL に載せる", () => {
    vi.stubGlobal("window", {
      location: {
        href: "https://example.com/sequencer",
      },
    ...
    expect(
      buildSequencerUrl({
        ...
        kit: "drum-standard",
        pattern:
          "1000100010001000_0000100000000000_1010101000100000_0000000010000000_0000000001010000_0000001000000000_0000000000000011_0000000000001100",
        swing: 0.06,
      }),
    ).toBe(
      "/sequencer?bpm=122&stepsPerBeat=4&beatsPerLoop=4&kit=drum-standard&pattern=1000100010001000_0000100000000000_1010101000100000_0000000010000000_0000000001010000_0000001000000000_0000000000000011_0000000000001100&swing=0.06",
    );
  });
});
